...
function CheckinBooking() {
  ...
  const { booking, isPending: isLoading } = useBooking();
  ...
  return (
    <>
      ...
      <Box>
        ...
        >
          I confirm that the guests {guests.fullName} has paid the total price of {!addBreakfast ? formatCurrency(totalPrice) : `${formatCurrency(totalPrice + optionalBreakfastPrice)} (${formatCurrency(totalPrice)} + ${formatCurrency(optionalBreakfastPrice)})`} for this booking.
        </Checkbox>
      </Box>
